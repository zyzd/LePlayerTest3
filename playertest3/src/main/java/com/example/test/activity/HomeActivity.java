...
import com.letv.simple.utils.ReadFileFromAssertUtil;
import com.letv.simple.utils.SharedPreferenceUtil;
...
public class HomeActivity extends Activity implements OnClickListener, CopyDocFinishListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.active_player_hasSkin: {//生活直播播放器
