	...
	private OnPlayStateListener mainListener = new OnPlayStateListener() {
		...
		public void videoState(int state, Bundle bundle) {
			...
			case IPlayer.MEDIA_EVENT_VIDEO_SIZE:
				...
				RelativeLayout.LayoutParams params = new LayoutParams((int)(ratio*mainPlayer.getVideoWidth()),(int) (ratio*mainPlayer.getVideoHeight()));
	...
	private OnPlayStateListener assistListener = new OnPlayStateListener() {
		...
		public void videoState(int state, Bundle bundle) {
			...
			case IPlayer.MEDIA_EVENT_VIDEO_SIZE:
				...
				RelativeLayout.LayoutParams params = new LayoutParams((int)(ratio*assistPlayer.getVideoWidth()),(int)( ratio*assistPlayer.getVideoHeight()));
				params.addRule(RelativeLayout.CENTER_IN_PARENT);
