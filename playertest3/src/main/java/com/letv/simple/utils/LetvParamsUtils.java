...
public class LetvParamsUtils {
    ...
    public static Bundle setLiveParams(String streamId, String liveId, boolean isHls, boolean isLetv) {
        ...
        mBundle.putInt(PlayProxy.PLAY_MODE, EventPlayProxy.PLAYER_LIVE);//播放模式：直播
         ...
         */
        mBundle.putString(PlayProxy.PLAY_STREAMID, streamId);//直播流id
        mBundle.putString(PlayProxy.PLAY_LIVEID, liveId);//直播id
