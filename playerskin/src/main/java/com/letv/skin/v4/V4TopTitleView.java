...
public class V4TopTitleView extends BaseView implements UIObserver {
    ...
    protected void initView(final Context context) {
        ...
        mImageBtnSetting = (ImageButton) findViewById(R.id.imageBtn_setting);
        mImageBtnSetting.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                topTitleListener.onSettingClick();
            }
        });
        /**
         * 返回键
    ...
    //自个添加的
    private ITopTitleListener topTitleListener;
    public interface ITopTitleListener{
        void onSettingClick();
    }
    public void setOnTopTitleListener(ITopTitleListener topTitleListener){
        this.topTitleListener = topTitleListener;
    }
}
