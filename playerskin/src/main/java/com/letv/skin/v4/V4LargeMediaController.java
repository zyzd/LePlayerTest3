...
import com.letv.skin.bean.MessageEvent;
...
public class V4LargeMediaController extends BaseMediaController {
    ...
    protected void onInitView() {
        ...
        mBtnSend.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                EventBus.getDefault().post(ConstantUtils.EVENT_SHOW_SENDDANMAKU_DIALOG);
            }
        });
    }
    ...
    @Override
    protected void initPlayer() {//初始化播放器，当处于停止或播放完成时，重置
        initTimer(player);
